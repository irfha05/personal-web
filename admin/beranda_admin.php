...
<div class="flex max-w-7xl mx-auto mt-8 px-4 gap-6">
    <aside class="w-1/4 bg-fuchsia-300 dark:bg-gray-800 rounded shadow p-6">
        <h2 class="text-xl font-semibold text-purple-700 dark:text-blue-400 mb-4 text-center">MENU</h2>
    ...
    <main class="w-3/4 bg-fuchsia-300 dark:bg-gray-800 rounded shadow p-6">
